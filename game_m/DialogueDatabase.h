...
public:
    ...
    std::vector<DialogueLine> getDialogue(std::string dialogueID) {
        ...
        if (dialogueID == "apartment_pc") {
            ...
            lines = {
                { L"МАРК: Черт... Ева, стой! Смотри туда, налево.", &markPortrait },
                { L"ЕВА: Это... мистер Грин? Сосед из сороковой квартиры? Что с его лицом?!", &evaPortrait },
                { L"МАРК: Он полностью потерял рассудок. Видишь эту серую вздувшуюся кожу? Вирус Фидеса добрался до нашего этажа... Приготовь Глок, Ева. Он идет прямо на нас!", &markPortrait }
            };
        }
